...
** Projectile (project interaction mode)
...
Auto-revert buffers, always:
#+BEGIN_SRC emacs-lisp
  ;; Automatically revert buffers, always!
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq racer-rust-src-path "/Users/sritchie/code/rust/rustc-1.12.0/src/")
